...
public class SPController {
    ...
    internal init(containerView: UIView, into parentView: UIView, at position: SPPosition, animationConfig: SPAnimator.Config) {
    ...
    public static func install(containerView: UIView, into parentView: UIView, at position: SPPosition, animationConfig: SPAnimator.Config) -> SPController {
